...
# Generated with
#  Jason.encode!(%{"vault" => Base.url_encode64(<<4::256>>), "project_api" => Base.url_encode64(<<5::256>>), "secret" => Base.url_encode64(<<7::256>>)})
...
# Corresponding secret machine token is "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzZWNyZXQifQ.QgWPtWPFbdPZBlku39JpzzHzLD4kBHNh4dWVrr9d-JM"
